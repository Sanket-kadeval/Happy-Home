...
<div class="container-fluid">
    <div class="row booking1 fixed-top" style="background-color: rgb(219,226,226);">
        <div class="col-md-12 text-center">
            <div class="booking ">
                <p class="font-weight-bold pt-2">Book Service <span style="font-size: 15px;" class="text-success pl-2"><i class="fa fa-phone" aria-hidden="true"></i> 9512140869 (9AM to 6PM)</span></p>
            </div>
        </div>
    </div>
</div>
 <nav class="navbar  navbar-expand-lg ">
        ...
        <a class="navbar-brand pt-2" href="index.php"><i class="fa fa-home pr-3 text-white" style="font-size: 50px;" aria-hidden="true"></i>Happy Home</a>
